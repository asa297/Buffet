...
import info.androidhive.navigationdrawer.fragment.CreateRoomFragment;
...
public class MainActivity extends AppCompatActivity  {
    ...
    private String sqlite_name,sqlite_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqlite_name = users.get("name").toString();
        sqlite_email = users.get("email").toString();
        Log.d("name", sqlite_name);
        Log.d("email", sqlite_email);
        // session manager
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText(sqlite_name);
        txtWebsite.setText(sqlite_email);
    ...
    private Fragment getHomeFragment() {
        switch (navItemIndex) {
            case 0:
                ...
                return homeFragment;
            case 1:
                // info.androidhive.navigationdrawer.promotion
